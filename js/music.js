...
function qq_musicpage() {
    if (urlinfo != '/music/') {
        ...
        document.getElementsByClassName('pace-running')[0].style.background = '/assets/images/bg1.jpg';
        document.getElementsByTagName('body')[0].style.background = '/assets/images/bg1.jpg';
